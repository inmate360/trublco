        ...
        <div class="flex items-center justify-between h-16">
            ...
            <div class="flex items-center gap-2">
                <?php if (isset($_SESSION['user_id'])): ?>
                    ...
                    <!-- Messages -->
                    <a href="messages.php" class="relative p-2 rounded-lg text-gh-muted hover:text-white hover:bg-gh-panel2 transition-colors">
                    ...
                    <!-- Notifications -->
                    <a href="notifications.php" class="relative p-2 rounded-lg text-gh-muted hover:text-white hover:bg-gh-panel2 transition-colors">
...
<div class="md:hidden fixed bottom-0 inset-x-0 z-40 border-t border-gh-border bg-gh-panel/95 backdrop-blur-sm">
    <div class="flex items-center justify-around h-16 px-2">
        ...
        <a href="post-ad.php" class="flex flex-col items-center gap-0.5 px-3 py-1 text-gh-accent">
            <i class="bi bi-plus-circle-fill text-2xl"></i>
            <span class="text-[10px]">Post</span>
        </a>
        <a href="messages.php" class="relative flex flex-col items-center gap-0.5 px-3 py-1 <?php echo $current_page === 'messages' ? 'text-gh-accent' : 'text-gh-muted'; ?>">
