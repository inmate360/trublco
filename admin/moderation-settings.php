...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $checkboxes = ['moderate_listings', 'moderate_marketplace', 'moderate_forum', 'moderate_profiles'];
    ...
    header('Location: moderation-settings.php?success=1');
    exit;
}
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-white">
                    <i class="bi bi-gear-fill mr-2 text-gh-accent"></i>
                    Moderation Settings
                </h1>
